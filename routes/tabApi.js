...
router.post("/sendActivityNotification", async (req, res, next) => {
  try {
    ...
    const chatMessage = {
      body: {
        contentType: "html",
        content: '<div style="border: 1px solid #EDEBE9;border-radius: 2px;height: 100%;padding: 16px;gap: 16px;"><p style="left: 0px;right: 0px;top: 0px;bottom: 0px;font-family: Segoe UI;color: #252423;font-weight: 700;font-size: 18px;line-height: 24px;"><strong>Hello, I’m MeetingCost bot</strong></p><br/><p style="height: 50px;font-family: "Segoe UI";font-weight: 400;font-size: 14px;color: #252423;">Thank you for joining<strong>' + ' ' +  req.body.meetingDetails[0].subject + ' ' + '</strong>hosted by<strong>' + ' ' + req.body.meetingDetails[0].participants["organizer"]['upn'] + '</strong></p><p style="ont-family: "Segoe UI";font-weight: 400;font-size: 14px;color: #252423;height:50px">' + req.body.meetingDetails[0].participants["organizer"]['upn'] + ' ' +' has turned on <strong>MeetingCost</strong> feature to calculate ongoing meeting cost.<br/>  <div style="display:flex;"> <div style="background-color:transparent;float: left;width: 50%;line-height:"><h1 style="font-weight: 600;font-size: 12px;">Organizer</h1><div style="display:flex;flex-direction:row;font-weight: 400;font-size: 14px;line-height: 20px;"><div style="align-items: center;display: flex;justify-content: center;background-color: #d1d5db;color: #fff;border-radius: 50%;height: 3rem;width: 3rem;">O</div> ' + '  ' + req.body.meetingDetails[0].participants["organizer"]['upn'] + '</div></div>  <div style="background-color:transparent;float: left;width: 50%;"><h1 style="font-weight: 600;font-size: 12px;">Meeting Time</h2><div style="display:flex;flex-direction:row;font-weight: 400;font-size: 14px;line-height: 20px;">' + ' ' + req.body.startTime + ' - ' +  req.body.endTime +' </div>'+ req.body.dateTime + '</div></div>' 
